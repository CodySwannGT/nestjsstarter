# Thumbwar Backend Wiki — LLM Wiki Contract

> Generated by the `lisa-wiki` plugin from `wiki/lisa-wiki.config.json`.
> kernelVersion: 2.115.4 · schemaVersion: 1.0.0 · rendered: 2026-05-28
...
## What this is
A git-native markdown knowledge base under `wiki/`, owned by **Thumbwar**, maintained by the
